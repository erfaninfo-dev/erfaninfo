-- آپدیت جدول users برای ویژگی‌های امنیتی جدید
-- اجرای این فایل برای آپدیت دیتابیس موجود

-- اضافه کردن ستون‌های جدید (فقط ستون‌های ضروری)
ALTER TABLE users 
...
-- تغییر ستون password_hash به nullable (برای OAuth users)
